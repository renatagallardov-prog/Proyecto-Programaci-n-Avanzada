...
public class DatosIniciales {
    ...
    public static void cargar(GestorParque gestor) {
        ...
        montania.agregarReserva(new Reserva("R001", "A01", g1, manana,
                LocalTime.of(11, 0), 20, EstadoReserva.CONFIRMADA));
        rio.agregarReserva(new Reserva("R002", "A02", g2, manana,
                LocalTime.of(12, 30), 4, EstadoReserva.PENDIENTE));
        espectaculo.agregarReserva(new Reserva("R003", "A04", g3, manana,
